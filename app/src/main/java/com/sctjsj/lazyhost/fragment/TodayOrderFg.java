 ...
 */
public class TodayOrderFg extends Fragment {
    ...
    public void initData() {
        try {
            ...
            //http://www.lp-kd.com/user/queryOrderformByStore$ajax.htm?&storeId=20&jf=goodscart|goods|addr|area|parent
            RequestParams params = new RequestParams(BnUrl.queryTodayOrder);
            ...
            x.http().post(params, new Callback.ProgressCallback<JSONObject>() {
                ...
                public void onError(Throwable ex, boolean isOnCallback) {
                    Log.e("TAG", "出错:" + ex.toString());
                    ToastUtils.showToas(getActivity(), "网络状态不佳，请重试。");
                }
    ...
    class MyAdapter extends RecyclerView.Adapter<XHolder> {
        ...
        public XHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View item = LayoutInflater.from(getActivity()).inflate(R.layout.item_of_fg_today_order, null);
        ...
        public void onBindViewHolder(XHolder holder, final int position) {
            ...
            if (3 == app.getCurrentUser().getShopType()) {
                ...
                holder.tvTake.setText(data.get(position).getTakeTime());
            } else {
            ...
            if (data.get(position).getDeliveryAddressBean() != null) {
                ...
                holder.mLLConsigneeParent.setVisibility(View.GONE);
            }
            //查看买家信息
            ...
            //包装费
            holder.tvPackagePrice.setText("￥" + NumformatUtil.save2(data.get(position).getPackagePrice()));
            //商家简号
    ...
    class XHolder extends ViewHolder {
        TextView mTVAddress, mTVConsignee, mTVPaytime, mTVOrderNum,
                mTVGoodsPay, mTVTotalPay, mTVShipprice, mTVDisprice, mTVQueryBuyer, mTVGeneralRemind;
        ListView mLV;
        LinearLayout mLLConsigneeParent;
        LinearLayout mLLTime;

        TextView tvTake, tvSendTime;
        ...
        public XHolder(View itemView) {
            ...
            mTVQueryBuyer = (TextView) itemView.findViewById(R.id.item_today_tv_query_buyer);
            ...
            tvTake = (TextView) itemView.findViewById(R.id.tv_take_time);
            tvSendTime = (TextView) itemView.findViewById(R.id.tv_send_time);
            tvPackagePrice = (TextView) itemView.findViewById(R.id.item_of_fg_dispose_tv_packagePrice);
