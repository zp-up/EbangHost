...
import com.sctjsj.lazyhost.receiver.AlarmReceiver;
import com.sctjsj.lazyhost.util.AuthorityUtil;
...
public class SessionFlushService extends Service {
    ...
    private void flushHttp(){
        ...
        Intent intent = new Intent("ACTION_REFRESH_HOST");
