...
import com.sctjsj.lazyhost.adapter.MainShopVPAdapter;
import com.sctjsj.lazyhost.application.MyApp;
import com.sctjsj.lazyhost.bean.Dish;
import com.sctjsj.lazyhost.bean.DishMenu;
import com.sctjsj.lazyhost.bean.SettleCartBean;
import com.sctjsj.lazyhost.bean.ShopCart;
import com.sctjsj.lazyhost.fragment.CommentFgInShop;
import com.sctjsj.lazyhost.fragment.DetailFgInShop;
import com.sctjsj.lazyhost.fragment.GoodsFgInShop;
            ...
            public void onSuccess(JSONObject response) {
                if(response!=null){
                    ...
                    try {
                        ...
                        Glide.with(MainShopActivity.this).load(storeLogoUrl).into(mIVShopIcon);
                        Glide.with(MainShopActivity.this).load(storeLogoUrl).into(mIVBigBackground);
                        /**
                         * 商品分类
                         */
