...
import com.sctjsj.lazyhost.bean.GalleryBean;
import com.sctjsj.lazyhost.decoration.DividerItemDecoration;
...
public class GalleryMagActivity extends Activity implements TakePhoto.TakeResultListener,InvokeListener {
    ...
    class MyAdapter extends RecyclerView.Adapter<XH>{
        ...
        public void onBindViewHolder(XH holder, final int position) {
            Glide.with(GalleryMagActivity.this).load(galleryList.get(position).getUrl()).error(R.mipmap.icon_portrait_load_failed).into(holder.mIV);
