...
public class ModifyCommodityActivity extends Activity implements TakePhoto.TakeResultListener,InvokeListener{
    ...
    private void submit(){
        ...
        String json=new Gson().toJson(gbData);
            ...
            public void onSuccess(JSONObject response) {
                ...
                if(response!=null){
                    try {
                        ...
                        if(gbData!=null){
                            Picasso.with(ModifyCommodityActivity.this).load(gbData.getLogoUrl()).error(R.mipmap.icon_portrait_load_failed).into(mIVPreview);
