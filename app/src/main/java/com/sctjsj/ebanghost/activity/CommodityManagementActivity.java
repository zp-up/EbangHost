...
public class CommodityManagementActivity extends AppCompatActivity {
    ...
    @Bind(R.id.activity_commodity_rv)RecyclerView mRecyclerview;
    ...
    public class MyRVAdapter extends RecyclerView.Adapter<MyRVAdapter.MyXHolder>{
        ...
        public void onBindViewHolder(final MyXHolder holder, final int position) {
            ...
            Picasso.with(CommodityManagementActivity.this).load(data.get(position).getLogoUrl()).resize(DpUtils.dpToPx(CommodityManagementActivity.this,80),DpUtils.dpToPx(CommodityManagementActivity.this,80)).error(R.mipmap.icon_portrait_load_failed).into(holder.mIVLogo);
