...
import com.sctjsj.ebanghost.util.SmoothCheckBox;
                    ...
                    builder.setPositiveButton("确认修改", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if(!TextUtils.isEmpty(et.getText().toString())){
                                ...
                                Snackbar.make(mLLParent,"请输入修改后的类型名称",Snackbar.LENGTH_SHORT).show();
                            }
                ...
                builder.setPositiveButton("确认添加", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if(!TextUtils.isEmpty(et.getText().toString())){
                            ...
                            Snackbar.make(mLLParent,"请输入类型名称",Snackbar.LENGTH_SHORT).show();
                        }
